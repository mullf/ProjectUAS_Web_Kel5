...
<head>
    <title>Register | Sitem Informasi Iuran RT </title>
      <meta charset="utf-8">
      ...
      <link rel="icon" href="assets/images/newlogo.png" type="image/x-icon">
      <!-- Google font-->     
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <form class="md-float-material form-material" action="/register/save" method="post">
