                            ...
                            <div class="card-block">
                                ...
                                <form class="form-material" action="<?= base_url('iuran/update/'.$row['idIuran']) ?>" method="POST">
                                    <div class="form-group form-info form-static-label">
                                        <input type="text" name="idWarga" class="typeahead form-control" value="<?= $row['idWarga']; ?>" required="">
                                    ...
                                    <div class="form-group form-info form-static-label">
                                        <?php $db      = \Config\Database::connect();
                                            ...
                                            <input type="text" name="namaWarga" class="typeahead form-control" value="<?= $row2['namaWarga']; ?>" required="">
                                        <?php } ?>
                                        
                                        <span class="form-bar"></span>
                                        <label class="float-label">Nama Warga</label>
                                    </div>
